...
export async function CreateCheckoutSession(
  ...
  try {
    ...
    const sessionPayload: Stripe.Checkout.SessionCreateParams = {
      ...
      success_url: `${process.env.NEXT_PUBLIC_BASE_URL}/success?orderNumber=${metadata.orderNumber.slice(-10) ?? "N/A"}`,
...
//       payment_method_types: ["card"],
//        success_url: `${process.env.NEXT_PUBLIC_BASE_URL}/success?orderNumber=${metadata.orderNumber.slice(-10) ?? "N/A" }`,
//       // success_url: `${process.env.NEXT_PUBLIC_BASE_URL}/success?orderNumber={CHECKOUT_SESSION_ID}`,
