...
export type AllSanitySchemaTypes = SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityFileAsset | Geopoint | AboutUs | Sale | Order | Product | Category | Slug | BlockContent | SanityImageCrop | SanityImageHotspot | SanityImageAsset | SanityAssetSourceData | SanityImageMetadata;
export declare const internalGroqTypeReferenceTo: unique symbol;
// Source: ./sanity/helpers/querise.ts
// Variable: SALE_QUERY
...
// Variable: CATEGORISE_QUERY
// Query: *[_type == "category"] | order(name asc)
export type CATEGORISE_QUERYResult = Array<{
  _id: string;
  _type: "category";
  _createdAt: string;
  _updatedAt: string;
...
// Variable: ABOUT_US
// Query: *[_type == "aboutUs"]
export type ABOUT_USResult = Array<{
  _id: string;
  _type: "aboutUs";
  _createdAt: string;
  _updatedAt: string;
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type == \"category\"] | order(name asc)": CATEGORISE_QUERYResult;
